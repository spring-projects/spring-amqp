...
public class ListenFromAutoDeleteQueueTests {
	...
	public void testStopStart() throws Exception {
		...
		RabbitAdmin admin = spy(TestUtils.<RabbitAdmin>propertyValue(this.listenerContainer1, "amqpAdmin"));
	...
	public void testRedeclareXExpiresQueue() throws Exception {
		...
		RabbitAdmin admin = spy(TestUtils.<RabbitAdmin>propertyValue(listenerContainer, "amqpAdmin"));
