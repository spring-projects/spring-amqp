 ...
 *
 */
public class RabbitTemplateObservationConvention implements ObservationConvention<MessageSenderContext> {
	...
	@Override
	public KeyValues getHighCardinalityKeyValues(MessageSenderContext context) {
