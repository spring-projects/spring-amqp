...
public class RabbitBrokerAdmin implements RabbitBrokerOperations {
    ...
    public List<QueueInfo> getQueues() {
        return (List<QueueInfo>) erlangTemplate.executeAndConvertRpc(getControlAction(ListQueues.class), getBytes(DEFAULT_VHOST));
    }

    @SuppressWarnings("unchecked")
    public List<QueueInfo> getQueues(String virtualHost) {
        return (List<QueueInfo>) erlangTemplate.executeAndConvertRpc(getControlAction(ListQueues.class), getBytes(virtualHost));
    }
    ...
    public void startBrokerApplication() {
        ...
        Future<Object> result = executor.submit(new Callable<Object>() {
            public Object call() throws Exception {
                try {
                    return erlangTemplate.executeAndConvertRpc(getControlAction(StartBrokerApplication.class));
                } finally {
                    latch.countDown();
                }
            }
    ...
    public void stopBrokerApplication() {
        ...
        erlangTemplate.executeAndConvertRpc(getControlAction(StopBrokerApplication.class));
        if (timeout > 0) {
            waitForUnreadyState();
        }
    }
    ...
    public void stopNode() {
        ...
        try {
            erlangTemplate.executeAndConvertRpc(getControlAction(StopNode.class));
        } catch (Exception e) {
    ...
    public void resetNode() {
        erlangTemplate.executeAndConvertRpc(getControlAction(ResetNode.class));
    }

    @ManagedOperation
    public void forceResetNode() {
        erlangTemplate.executeAndConvertRpc(getControlAction(ForceResetNode.class));
    ...
    protected ControlAction getControlAction(Class type) {
        return controlActionMap.get(type);
    }
