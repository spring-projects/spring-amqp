...
| The number of connection objects representing connections to brokers; they may or may not currently be open.
These objects are wrappers for the actual connections.
