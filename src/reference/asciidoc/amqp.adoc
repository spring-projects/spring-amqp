...
IMPORTANT: Starting with version 2.4.8, the RabbitMQ `http-client` is no longer used to access the Rest API.
...
`CompletableFuture<?>` was added in 2.4.7 and `ListenableFuture<?>` will be removed in 3.0.
