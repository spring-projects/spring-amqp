...
This class was introduced in _version 2.1_ and can be used to convert messages from/to XML. This class considered the twine for `Jackson2JsonMessageConverter`.
In fact both of them share the same base class `AbstractJackson2MessageConverter`.
