...
NOTE: Starting with _version 2.1_ the class `AbstractJsonMessageConverter` has been deprecated; it is no longer the base class for `Jackson2JsonMessageConverter`.
It has been replace by `AbstractJackson2MessageConverter`.
...
NOTE: The class `AbstractJackson2MessageConverter` is introduced to replace the now-deprecating class `AbstractJsonMessageConverter`.
