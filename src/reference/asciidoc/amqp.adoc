...
Since _version 2.0_ all exchange types are supported here, please use constants from `ExchangeTypes` for the standard DIRECT, FANOUT, TOPIC and HEADERS exchange types.
