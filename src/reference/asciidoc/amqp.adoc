...
Each of the properties defined on the https://docs.spring.io/spring-amqp/docs/latest-ga/api/org/springframework/amqp/core/MessageProperties.html[MessageProperies] can be set.
...
You can read more about that library https://docs.spring.io/spring/docs/3.0.x/spring-framework-reference/html/oxm.html[here].
