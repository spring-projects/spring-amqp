...
Starting with version 2.2, `buildListenerArguments(Object)` has been deprecated and the new method `buildListenerArguments(Object, Channel, Message)` instead of its functions.
