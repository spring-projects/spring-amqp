...
This section describges the changes between version 2.0 and version 2.1.
...
Certain classes have moved to different packages. Most are internal classes and do not affect user applications.
