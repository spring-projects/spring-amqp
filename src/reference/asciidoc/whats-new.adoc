...
===== Drop off Jackson 1.x support

Deprecated in previous version Jackson `1.x` converters and related components have been deleted in favor of similar components based on the Jackson 2.x.
