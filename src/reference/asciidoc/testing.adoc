...
It currently only supports routing by queue name and provides a broadcast mechanism, sending the message to every container that is configured to listen to the queue.
