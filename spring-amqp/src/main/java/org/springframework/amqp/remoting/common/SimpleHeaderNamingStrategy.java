...
/**
 * Uses the parameters suggested in the {@link Method#equals(Object)} method with the omission of the declaring class:
 * That should be unnecessary in the given context.
 *
 * <p>
 * Will create a String of the form <code>returnType + " " + name + "(" + parameterTypes + ")"</code> which has the
 * side-effect of being human-readable.
 *
 * @author David Bilge
 * @author Gary Russell
 * @since 1.2
