 ...
 * form {@code spring.gen-<base64UUID>} by default, but it can be modified by providing a
...
public class AnonymousQueue extends Queue {
	...
	public AnonymousQueue() {
		this((Map<String, @Nullable Object>) null);
	}
	 ...
	 */
	public AnonymousQueue(@Nullable Map<String, @Nullable Object> arguments) {
