...
public class ConditionalRejectingErrorHandler implements ErrorHandler {
	...
	protected void log(Throwable throwable) {
		if (this.logger.isWarnEnabled()) {
			this.logger.warn("Execution of Rabbit message listener failed.", throwable);
		}
	}
	 ...
	 * {@link AmqpRejectAndDontRequeueException}.
	 */
	protected boolean causeChainContainsARADRE(Throwable throwable) {
	...
	public static class DefaultExceptionStrategy implements FatalExceptionStrategy {
		...
		public boolean isFatal(Throwable t) {
			...
			while ((cause instanceof MessagingException || cause instanceof IllegalStateException)
					&& !isCauseFatal(cause)) {
		 ...
		 * @param exception the {@link ListenerExecutionFailedException}.
