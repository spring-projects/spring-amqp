...
public class DefaultJavaTypeMapperTest {
	@Spy DefaultJavaTypeMapper javaTypeMapper = new DefaultJavaTypeMapper();
	...
	public void fromJavaTypeShouldPopulateWithContentTypeJavaTypeNameByDefault(){
		...
		javaTypeMapper.fromJavaType(TypeFactory.collectionType(containerClass, TypeFactory.type(SimpleTrade.class)), properties);
